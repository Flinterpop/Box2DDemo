...
public:
		...
		: Sample( settings )
	{
		...
		// Ground body  line across bottom
		{
			b2BodyDef bodyDef = b2DefaultBodyDef();
		...
		// Chain shape //highest object
		{
			...
			b2Vec2 points[4] = { { 0.0f, 1.0f }, { 0.0f, 2.0f }, { -1.0f, 2.0f }, { -2.0f, 1.0f } };
...
*/
		...
		// Chain loop. Collision should be smooth. //complex ramp
		{
			b2BodyDef bodyDef = b2DefaultBodyDef();
			...
			b2Vec2 points[10] = { { 0.0f, 0.0f }, { 6.0f, 0.0f },  { 6.0f, 2.0f },	{ 4.0f, 1.0f },	 { 2.0f, 2.0f },
								  { 0.0f, 2.0f }, { -2.0f, 2.0f }, { -4.0f, 3.0f }, { -16.0f, 2.0f }, { -16.0f, 0.0f } };
			b2ChainDef chainDef = b2DefaultChainDef();
			chainDef.points = points;
			chainDef.count = 10;
			chainDef.isLoop = true;
